...
const SlateEditor = (props) => {
  ...
  return (
    <div className="base-div" >
      ...
      {
        loggedIn && errorMessage === "Sie sind nicht berechtigt das gewünschte Dokument zu öffnen oder zu bearbeiten!"
          ? <Redirect to={{ pathname: "/permission", state: { message: errorMessage, docId } }} />
          : null
      }

      {
        (loggedIn && errorMessage !== "Sie sind nicht berechtigt das gewünschte Dokument zu öffnen oder zu bearbeiten!" && errorMessage !== "")
      ...
      {
        loggedIn ? null : <Redirect to="/anmelden" />
      }
      ...
      <div className="doc-info" >
        ...
        <div>
          {
            saved
              ? <p className="automatic-save" style={{ color: "#f0a58c"}} >Aktualisiert</p>
              : <p style={{ color: "#f0a58c"}} >Aktualisiert</p>
          }
        </div>
